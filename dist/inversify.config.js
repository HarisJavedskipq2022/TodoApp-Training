...
const TodoRepository_1 = __importDefault(require("./src/infrastructure/repositories/TodoRepository"));
const UserRepository_1 = __importDefault(require("./src/infrastructure/repositories/UserRepository"));
...
exports.container.bind('TodoRepository').to(TodoRepository_1.default);
exports.container.bind('UserRepository').to(UserRepository_1.default);
